...
class TestDataGetById(MongoIntegrationBaseTestCase):
    ...
    def test_get_by_id_owner_with_read_access_returns_data(self, get_all_workspaces_with_read_access_by_user):
    ...
    @modify_settings(INSTALLED_APPS={'append': 'core_workspace_app'})
    @patch('core_workspace_app.components.workspace.api.get_all_workspaces_with_read_access_by_user')
    def test_get_by_id_owner_without_read_access_returns_data(self, get_all_workspaces_with_read_access_by_user):
        data_id = self.fixture.data_collection[fixture_data.USER_1_WORKSPACE_1].id
        mock_user = _create_user('1')
    ...
    @modify_settings(INSTALLED_APPS={'append': 'core_workspace_app'})
    @patch('core_workspace_app.components.workspace.api.get_all_workspaces_with_read_access_by_user')
    def test_get_by_id_user_without_read_access_raises_error(self, get_all_workspaces_with_read_access_by_user):
        data_id = self.fixture.data_collection[fixture_data.USER_1_WORKSPACE_1].id
...
class TestDataGetAllExceptUser(MongoIntegrationBaseTestCase):
    ...
    @modify_settings(INSTALLED_APPS={'append': 'core_workspace_app'})
    @patch('core_workspace_app.components.workspace.api.get_all_workspaces_with_read_access_by_user')
    def test_get_all_except_user_raises_error_if_no_workspace_access(self, get_all_workspaces_with_read_access_by_user):
        mock_user = _create_user('1')
        get_all_workspaces_with_read_access_by_user.return_value = []
        with self.assertRaises(AccessControlError):
            data_api.get_all_except_user(mock_user)
    ...
    @modify_settings(INSTALLED_APPS={'append': 'core_workspace_app'})
    @patch('core_workspace_app.components.workspace.api.get_all_workspaces_with_read_access_by_user')
    def test_get_all_except_user_raises_error_data_if_workspace_access(self, get_all_workspaces_with_read_access_by_user):
        mock_user = _create_user('1')
        get_all_workspaces_with_read_access_by_user.return_value = [fixture_data.workspace_1,
...
class TestDataExecuteQuery(MongoIntegrationBaseTestCase):
    ...
    @modify_settings(INSTALLED_APPS={'append': 'core_workspace_app'})
    @patch('core_workspace_app.components.workspace.api.get_all_workspaces_with_read_access_by_user')
    def test_execute_query_returns_data(self, get_all_workspaces_with_read_access_by_user):
        mock_user = _create_user('3')
        get_all_workspaces_with_read_access_by_user.return_value = [fixture_data.workspace_1]
    ...
    @modify_settings(INSTALLED_APPS={'append': 'core_workspace_app'})
    @patch('core_workspace_app.components.workspace.api.get_all_workspaces_with_read_access_by_user')
    def test_execute_query_returns_data_in_workspace_1(self, get_all_workspaces_with_read_access_by_user):
        mock_user = _create_user('3')
        get_all_workspaces_with_read_access_by_user.return_value = [fixture_data.workspace_1]
        data_list = data_api.execute_query({}, mock_user)
    ...
    @modify_settings(INSTALLED_APPS={'append': 'core_workspace_app'})
    @patch('core_workspace_app.components.workspace.api.get_all_workspaces_with_read_access_by_user')
    def test_execute_query_returns_data_in_workspace_2(self, get_all_workspaces_with_read_access_by_user):
        mock_user = _create_user('3')
        get_all_workspaces_with_read_access_by_user.return_value = [fixture_data.workspace_1]
        data_list = data_api.execute_query({}, mock_user)
        self.assertTrue(data_list.count() == 1)
    ...
    @modify_settings(INSTALLED_APPS={'append': 'core_workspace_app'})
    @patch('core_workspace_app.components.workspace.api.get_all_workspaces_with_read_access_by_user')
    def test_execute_query_force_workspace_1_returns_data_from_workspace_1(self, get_all_workspaces_with_read_access_by_user):
        mock_user = _create_user('3')
        get_all_workspaces_with_read_access_by_user.return_value = [fixture_data.workspace_1]
    ...
    @modify_settings(INSTALLED_APPS={'append': 'core_workspace_app'})
    @patch('core_workspace_app.components.workspace.api.get_all_workspaces_with_read_access_by_user')
    def test_execute_query_force_workspace_1_does_not_return_data_if_no_access(self, get_all_workspaces_with_read_access_by_user):
        mock_user = _create_user('3')
        get_all_workspaces_with_read_access_by_user.return_value = []
        data_list = data_api.execute_query({'workspace': fixture_data.workspace_1.id}, mock_user)
        self.assertTrue(data_list.count() == 0)
    ...
    @modify_settings(INSTALLED_APPS={'append': 'core_workspace_app'})
    @patch('core_workspace_app.components.workspace.api.get_all_workspaces_with_read_access_by_user')
    def test_execute_query_force_workspace_none_does_not_return_data_if_no_access(self, get_all_workspaces_with_read_access_by_user):
        mock_user = _create_user('3')
        get_all_workspaces_with_read_access_by_user.return_value = []
...
class TestDataDelete(MongoIntegrationBaseTestCase):
    ...
    @modify_settings(INSTALLED_APPS={'append': 'core_workspace_app'})
    @patch('core_workspace_app.components.workspace.api.get_all_workspaces_with_write_access_by_user')
    def test_delete_own_data_in_accessible_workspace_deletes_data(self, get_all_workspaces_with_write_access_by_user):
        mock_user = _create_user('1')
        get_all_workspaces_with_write_access_by_user.return_value = [fixture_data.workspace_1]
        data_api.delete(fixture_data.data_collection[fixture_data.USER_1_WORKSPACE_1], mock_user)

    @unittest.skip("GridFS not supported by mongomock")
    @modify_settings(INSTALLED_APPS={'append': 'core_workspace_app'})
    @patch('core_workspace_app.components.workspace.api.get_all_workspaces_with_write_access_by_user')
    def test_delete_own_data_in_not_accessible_workspace_deletes_data(self, get_all_workspaces_with_write_access_by_user):
        mock_user = _create_user('1')
    ...
    @modify_settings(INSTALLED_APPS={'append': 'core_workspace_app'})
    @patch('core_workspace_app.components.workspace.api.get_all_workspaces_with_write_access_by_user')
    def test_delete_others_data_in_accessible_workspace_deletes_data(self, get_all_workspaces_with_write_access_by_user):
        mock_user = _create_user('1')
        get_all_workspaces_with_write_access_by_user.return_value = [fixture_data.workspace_2]
        data_api.delete(fixture_data.data_collection[fixture_data.USER_2_WORKSPACE_2], mock_user)

    @modify_settings(INSTALLED_APPS={'append': 'core_workspace_app'})
    @patch('core_workspace_app.components.workspace.api.get_all_workspaces_with_write_access_by_user')
    def test_delete_others_data_not_accessible_workspace_raises_error(self, get_all_workspaces_with_write_access_by_user):
        mock_user = _create_user('1')
        get_all_workspaces_with_write_access_by_user.return_value = [fixture_data.workspace_1]
        with self.assertRaises(AccessControlError):
            data_api.delete(fixture_data.data_collection[fixture_data.USER_2_WORKSPACE_2], mock_user)
    ...
    @unittest.skip("GridFS not supported by mongomock")
    @patch('core_workspace_app.components.workspace.api.get_all_workspaces_with_write_access_by_user')
    def test_delete_own_data_not_in_workspace_deletes_data(self, get_all_workspaces_with_write_access_by_user):
        mock_user = _create_user('1')
        get_all_workspaces_with_write_access_by_user.return_value = []
        with self.assertRaises(AccessControlError):
            data_api.delete(fixture_data.data_collection[fixture_data.USER_1_WORKSPACE_1], mock_user)
    ...
    @modify_settings(INSTALLED_APPS={'append': 'core_workspace_app'})
    @patch('core_workspace_app.components.workspace.api.get_all_workspaces_with_write_access_by_user')
    def test_delete_others_data_not_in_workspace_raises_error(self, get_all_workspaces_with_write_access_by_user):
        mock_user = _create_user('1')
        get_all_workspaces_with_write_access_by_user.return_value = []
        with self.assertRaises(AccessControlError):
