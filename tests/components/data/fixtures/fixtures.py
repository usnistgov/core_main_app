...
class AccessControlDataNumericFixture(FixtureInterface):
    """Access Control Data fixture
    - User1: 1 private data
    - User2: 1 data in workspace 1
    - User3: 1 private data and 1 data in workspace 1
    ...
    def generate_data_collection(self):
        ...
        # value: 1
        xml_content_1 = "<root><element>1</element></root>"
        # value: 2
        xml_content_2 = "<root><element>2</element></root>"
        # value: 31
        xml_content_3_1 = "<root><element>31</element></root>"
        # value: 32
        xml_content_3_2 = "<root><element>32</element></root>"
...
class AccessControlJSONDataListFixture(FixtureInterface):
    """Access Control Data fixture
    - User1: 1 private data
    - User2: 1 data in workspace 1
    - User3: 1 private data and 1 data in workspace 1
    ...
    def generate_data_collection(self):
        ...
        # value: 1
        json_content_1 = '{"list": ["value1"]}'
        # value: 2
        json_content_2 = '{"list": ["value1", "value2"]}'
        # value: 31
        json_content_3_1 = '{"list": ["value31"]}'
        # value: 31
        json_content_3_2 = '{"list": ["value32"]}'

        self.data_1 = Data(
            template=self.template,
            title="Data 1",
            user_id="1",
            content=json_content_1,
        )
        self.data_1.convert_and_save()
        self.data_2 = Data(
            template=self.template,
    ...
    def generate_template(self):
        ...
        self.template.hash = ""
        self.template.format = "JSON"
        self.template.filename = "filename.json"
        self.template.save()
...
class AccessControlDataNoneFixture(FixtureInterface):
    """Access Control Data fixture
    - User1: 1 private data
    - User2: 1 data in workspace 1
    """
    ...
    def generate_data_collection(self):
        ...
        # value: 1
        xml_content_1 = "<root><element></element></root>"
        # value: 2
        xml_content_2 = "<root><element>value</element></root>"
