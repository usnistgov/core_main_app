...
urlpatterns = [
    ...
    re_path(
        r"^template/disable",
        common_ajax.disable_version_manager,
        name="core_main_app_disable_template",
    ),
    re_path(
        r"^template/restore",
        common_ajax.restore_version_manager,
    ...
    re_path(
        ...
        common_ajax.set_current_template_version_from_version_manager,
    ...
    re_path(
        r"^public-workspace",
        user_ajax.set_public_workspace,
        name="core_main_public_workspace",
    ),
    re_path(
        r"^private-workspace",
        user_ajax.set_private_workspace,
        name="core_main_private_workspace",
    ),
    re_path(
        r"^add-user-form",
